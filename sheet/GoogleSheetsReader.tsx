...
const GoogleSheetsReader: React.FC = () => {
  ...
  const CLIENT_ID = '173804678799-cddgsahit061vf4rdprhtlermd7cckj1.apps.googleusercontent.com';
  const API_KEY = 'AIzaSyB4Hm0UydtIe9yPQIetmY9MYE6vo3BLfLE';
  const DISCOVERY_DOC = 'https://sheets.googleapis.com/$discovery/rest?version=v4';
  const SPREADSHEET_ID = '1-CaPCzgjL9XQ6Ts4JSyVz9OFC08ZKPFY5voPjtHRcic';
  ...
  const fetchSheetData = useCallback(async () => {
    ...
    try {
      ...
      const sheetData: SheetData[] = values.map(row => ({
        name: row[0] || 'Unknown',
        major: row[4] || 'Unknown'
      }));
          ...
          <div className="flex items-start">
            ...
            <div className="ml-3">
              ...
              <p className="text-sm text-blue-700 mt-1">
                This component uses the modern Google Identity Services library with JWT ID tokens for secure authentication and Google Sheets API access.
              </p>
              <p className="text-sm text-blue-700 mt-1">
