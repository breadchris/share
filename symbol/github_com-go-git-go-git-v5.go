...
func init() {
	Symbols["github.com/go-git/go-git/v5/git"] = map[string]reflect.Value{
		...
		"Empty":                              reflect.ValueOf(git.Empty),
		...
		"ErrNoRestorePaths":                  reflect.ValueOf(&git.ErrNoRestorePaths).Elem(),
		...
		"ErrRestoreWorktreeOnlyNotSupported": reflect.ValueOf(&git.ErrRestoreWorktreeOnlyNotSupported).Elem(),
		...
		"ErrUnsupportedStatusStrategy":       reflect.ValueOf(&git.ErrUnsupportedStatusStrategy).Elem(),
		...
		"Preload":                            reflect.ValueOf(git.Preload),
		...
		"RestoreOptions":         reflect.ValueOf((*git.RestoreOptions)(nil)),
		"Signer":                 reflect.ValueOf((*git.Signer)(nil)),
		"Status":                 reflect.ValueOf((*git.Status)(nil)),
		"StatusCode":             reflect.ValueOf((*git.StatusCode)(nil)),
		"StatusOptions":          reflect.ValueOf((*git.StatusOptions)(nil)),
		"StatusStrategy":         reflect.ValueOf((*git.StatusStrategy)(nil)),
