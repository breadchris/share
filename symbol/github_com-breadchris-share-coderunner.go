...
func init() {
	Symbols["github.com/breadchris/share/coderunner/coderunner"] = map[string]reflect.Value{
		...
		"ServeFullRenderComponent":          reflect.ValueOf(coderunner.ServeFullRenderComponent),
		"ServeFullRenderComponentWithProps": reflect.ValueOf(coderunner.ServeFullRenderComponentWithProps),
		...
		"BuildComponentResult": reflect.ValueOf((*coderunner.BuildComponentResult)(nil)),
